...
class GetNewsetBooksUseCase extends BaseUseCases<Books, NoParameters> {
  final HomeRepository homeRepository;

  GetNewsetBooksUseCase({required this.homeRepository});
  @override
  Future<Either<Failure, Books>> call(NoParameters parameters) async {
    return await homeRepository.getNewestBooks();
  }
}
